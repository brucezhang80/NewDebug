...
#ifdef Q_OS_WIN
    /*2013-7-5 by macai: fileName.toStdWString().c_str()
     *转成LPSTSTR字符编码,需要在UNICODE下才能使用,在非UNICODE
     *情况下,请出现无法转换的bug,需要使用QString.toLocal8Bit().constData()
     *emial:12319597@qq.com
    */
