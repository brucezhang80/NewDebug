...
#ifndef MEDIAPLAYLISTVIEW_H
#define MEDIAPLAYLISTVIEW_H

#include <QTreeWidget>

class MediaPlayListView : public QTreeWidget
{
    Q_OBJECT
public:
    explicit MediaPlayListView(QWidget *parent = 0);
...
private slots:
    void selectedChildren(QTreeWidgetItem *, int);

private:

};

#endif // MEDIAPLAYLISTVIEW_H
