...
//    isSealed = set->value("isSealed", isSealed).toBool();
    ...
    isNoAutoPopupMsg = set->value("isNoAutoPopupMsg", isNoAutoPopupMsg).toBool();
...
//    noLogLockMsgBeforeOpen = set->value("noLogLockMsgBeforeOpen", noLogLockMsgBeforeOpen).toBool();
    isLogLoginName = set->value("isLogLoginName", isLogLoginName).toBool();
    isLogIP = set->value("isLogIP", isLogIP).toBool();
    ...
    userSearchHistory = set->value("userSearchHistory", userSearchHistory).toString();
    userSearchList = userSearchHistory.split(QChar('\r'));
    set->endGroup();

    set->beginGroup("BroadcastIp");
//    userSpecifiedBroadcastIp = set->value("userSpecifiedBroadcastIp", userSpecifiedBroadcastIp).toString();
//    userSpecifiedBroadcastIpList = userSpecifiedBroadcastIp.split(QChar('\r'), QString::SkipEmptyParts);
    set->endGroup();

    set->beginGroup("Transfer");
//    transferCodecName = set->value("transferCodecName", transferCodecName).toString();
    set->endGroup();
...
//    set->setValue("noLogLockMsgBeforeOpen", noLogLockMsgBeforeOpen);
    ...
    set->beginGroup("BroadcastIp");
//    set->setValue("userSpecifiedBroadcastIp", userSpecifiedBroadcastIpList.join("\r"));
    set->endGroup();
